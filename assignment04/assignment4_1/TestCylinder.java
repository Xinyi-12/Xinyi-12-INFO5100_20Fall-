...
public class TestCylinder {
    public static void main(String[] args) {
        ...
        System.out.println("Raduis is " + cylinder.getRaduis() + ", Height is " + cylinder.getHeight()  +
                ", Color is " + cylinder.getColor() + ", Base area is " + cylinder.getArea(1.0,"red") +
        ...
        System.out.println("Raduis is " + cylinder02.getRaduis() + ", Height is " + cylinder02.getHeight()  +
                " , Color is " + cylinder02.getColor() + ", Base area is " + cylinder02.getArea(2.0,"red") +
...
//Raduis is 1.0, Height is 1.0, Color is red, Base area is 3.14, Volume is 6.28
//Raduis is 2.0, Height is 5.0 , Color is red, Base area is 12.56, Volume is 314.0