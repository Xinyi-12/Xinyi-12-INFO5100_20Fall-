...
public class TestCylinder {
    public static void main(String[] args) {
        ...
        System.out.println("Raduis is " + circle.getRaduis() + ", Color is " + circle.getColor() +
                ", Base area is " + circle.getArea(2.0,"yellow"));
        ...
        System.out.println("Raduis is " + cylinder.getRaduis() + ", Height is " + cylinder.getHeight()  +
                ", Color is " + cylinder.getColor() + ", Base area is " + cylinder.getArea(2.0,"yellow") +
        ...
        System.out.println("Raduis is " + cylinder02.getRaduis() + ", Height is " + cylinder02.getHeight()  +
                " , Color is " + cylinder02.getColor() + ", Base area is " + cylinder02.getArea(2.0,"yellow") +
                ", Volume is " + cylinder02.getVolume(2.0,5.0,"red"));
    }

}
//print out:
//Raduis is 2.0, Color is yellow, Base area is 12.4
//Raduis is 1.0, Height is 1.0, Color is red, Base area is 12.4, Volume is 6.2
//Raduis is 2.0, Height is 5.0 , Color is red, Base area is 12.4, Volume is 310.0